	...
	return &ServerMetrics{
		serverRequestCounter: promauto.NewCounterVec(
			prom.CounterOpts{
				...
				Help: "Total number of RPCS completed on the server, regardless of success of failure",
			}, []string{"service", "method"}),
		serverCodeCounter: promauto.NewCounterVec(
			prom.CounterOpts{
				Name: "koala_server_handled_code_total",
				Help: "Total number of RPCS completed on server, regardless of success of failure",
